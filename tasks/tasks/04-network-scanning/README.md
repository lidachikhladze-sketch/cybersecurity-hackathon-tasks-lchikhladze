...
Target IP (training / practice context):  116.203.39.76
...
SSL/TLS info (if port 443 was open)
...
How to enumerate services on a remote host

How to validate Nmap results using OSINT

Why exposed services can be security risks

Importance of keeping software patched and minimizing attack surface

This exercise strengthened my understanding of practical reconnaissance techniques used during ethical hacking engagements.
